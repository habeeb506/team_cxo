...
// -- e.g. two widgets resolving the same machine identity on first
// render -- share one network request instead of firing a duplicate
// one before either has resolved (a resolved-value TTL cache alone
// doesn't catch this: both callers would still miss the cache
// simultaneously since neither has written to it yet).
